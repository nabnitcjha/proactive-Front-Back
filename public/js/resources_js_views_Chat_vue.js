...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,pinia__WEBPACK_IMPORTED_MODULE_1__.mapActions)(_stores_chatInfo__WEBPACK_IMPORTED_MODULE_0__.chatInfoStore, ["setMessageInfo"])), {}, {
    fetchMessages: function fetchMessages() {
      var _this = this;
      var friend_id = 1;
      var my_id = 1;
      urlText = "http://127.0.0.1:8000/api/messages" + "/" + friend_id + "/" + my_id;
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("http://127.0.0.1:8000/api/messages").then(function (response) {
        _this.setMessageInfo(response.data.data);
      });
    },
    addMessage: function addMessage() {
      var _this2 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var friend_id, my_id, formData, urlText, postResponse;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              formData.append("message_info[message]", _this2.newMessage);
              urlText = "messages";
